...
<script>
    ...
    //ModalCetakTransaksi
    $('#ModalCetakTransaksi').on('show.bs.modal', function (e) {
        var Loading='<div class="row text-center"><div class="form-group col col-md-12"><img src="images/loading.gif"></div></div>';
        $('#CetakTransaksi').html(Loading);
        var id_transaksi = $(e.relatedTarget).data('id');
        $.ajax({
            type 	: 'POST',
            url 	: '_Page/Transaksi/PilihanFormatCetakTransaksi.php',
            data 	:  { id_transaksi: id_transaksi },
            success : function(data){
                $('#CetakTransaksi').html(data);
                $('#PrintDetailDirect').click(function(){
                    var kode_transaksi= $('#PrintDetailDirect').val();
                    $.ajax({
                        type 	: 'POST',
...
<div class="modal-footer bg-primary">
    <div class="row">
        <div class="form-group col-md-12 text-center">
            ...
            <button class="btn btn-dark" data-toggle="modal" data-toggle="modal" data-target="#ModalCetakTransaksi" data-id="<?php echo $id_transaksi;?>">
