...
<form action="javascript:void(0);" autocomplete="off" id="ProsesPilihBarang">
    <input type="hidden" id="FormGetHarga1" value="<?php echo "$harga_1"; ?>">
    <input type="hidden" id="FormGetHarga2" value="<?php echo "$harga_2"; ?>">
    <input type="hidden" id="FormGetHarga3" value="<?php echo "$harga_3"; ?>">
    <input type="hidden" id="FormGetHarga4" value="<?php echo "$harga_4"; ?>">
    <input type="hidden" name="token" value="<?php echo "$milliseconds"; ?>">
