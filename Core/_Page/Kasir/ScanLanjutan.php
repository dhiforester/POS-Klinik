    ...
    <div class="col col-md-6 text-left">
        ...
        <select name="id_multi" id="id_multi_scan" class="form-control">
...
?>
<script>
    $('#id_multi_scan').focus(function(){
        $('#id_multi_scan').addClass("border-danger");
    });
    $('#id_multi_scan').focusout(function(){
        $('#id_multi_scan').removeClass("border-danger");
    });
    ...
    $('#id_multi_scan').change(function(){
        var id_multi_scan =$('#id_multi_scan').val();
        var StandarHarga = $('#StandarHargaScan').val();
        var IdBarang ="<?php echo $IdBarang;?>";
        if(id_multi_scan=="Satuan Utama"){
            ...
            $.ajax({
                ...
                data 	: {StandarHarga: StandarHarga, IdBarang: IdBarang, id_multi: id_multi_scan},
