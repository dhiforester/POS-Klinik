<?php
    ...
    //hitung jumlah data
    if(empty($keyword)){
        $jml_data = mysqli_num_rows(mysqli_query($conn, "SELECT*FROM transaksi WHERE keterangan!='Lunas'"));
    }else{
        $jml_data = mysqli_num_rows(mysqli_query($conn, "SELECT*FROM transaksi WHERE keterangan!='Lunas' AND kode_transaksi like '%$keyword%' OR tanggal like '%$keyword%'"));
    }
    //Jumlah halaman
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php
                    ...
                    if(empty($keyword)){
                        $query = mysqli_query($conn, "SELECT*FROM transaksi WHERE keterangan!='Lunas' ORDER BY id_transaksi DESC LIMIT $posisi, $batas");
                    }else{
                        $query = mysqli_query($conn, "SELECT*FROM transaksi WHERE  keterangan!='Lunas' AND kode_transaksi like '%$keyword%' OR tanggal like '%$keyword%' ORDER BY id_transaksi DESC LIMIT $posisi, $batas");
                    }
