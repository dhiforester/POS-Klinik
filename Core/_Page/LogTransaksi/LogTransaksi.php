...
<div class="row">
    ...
    <div class="col col-md-8 grid-margin stretch-card text-center">
        <div class="card card-statistics">
            <div class="card-body">
                <button type="button" class="btn btn-sm btn-outline-primary mr-2 mt-2" id="SemuaTransaksi">
                    <i class="mdi mdi-check-all"></i> All
                </button>
                <button type="button" class="btn btn-sm btn-outline-info mr-2 mt-2" id="Penjualan">
                    <i class="mdi mdi-coins"></i> Jual
                </button>
                <button type="button" class="btn btn-sm btn-outline-info mr-2 mt-2" id="Pembelian">
                    <i class="mdi mdi-shopping"></i> Beli
                </button>
                <button type="button" class="btn btn-sm btn-outline-info mr-2 mt-2" id="UtangPiutang">
                    <i class="mdi mdi-book-multiple"></i> U/P
                </button>
                <small class="dropdown">
                    <button type="button" class="btn btn-sm btn-outline-warning mr-2 mt-2" id="TransaksiRetur" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <small class="dropdown">
                    <button type="button" class="btn btn-sm btn-outline-danger mr-2 mt-2" id="Lainnya" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
