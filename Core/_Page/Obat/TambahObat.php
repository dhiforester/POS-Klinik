    ...
    <div class="col col-md-9 grid-margin stretch-card">
        <div class="card card-statistics">
            <div class="card-body">
                ...
                <small>
                    Tambah data barang, atur kategori, satuan dan harga.
                </small>
            </div>
        </div>
    </div>
    <div tabindex="0" onmousemove="this.style.cursor='pointer'" class="col-md-3 grid-margin stretch-card text-center">
        <div class="card card-statistics bg-inverse-dark" id="KembaliDataObat">
            <div class="card-body">
                <div class="form-group col-md col-6 text-center">
                    <i class="menu-icon mdi mdi-arrow-top-left icon-md"></i><br>
                    Kembali (Esc)
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <form action="javascript:void(0);" id="ProsesTambahObat" autocomplete="off">
                <div class="card-header">
                    <h4 class="">Form Tambah Data Barang</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
