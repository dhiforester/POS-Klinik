...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-2">
            <label>Barcode</label>
            <input type="text" readonly class="form-control border-dark" id="BarcodeMulti" value="<?php echo "$kode"; ?>">
        </div>
    ...
    <form action="javascript:void(0);" id="ProsesInputMultiHarga">
        ...
        <div class="row">
            <div class="form-group col-md-2">
                <input type="text" require class="form-control border-dark" name="BarcodeMulti" id="BarcodeMulti" value="<?php if(empty($BarcodeMulti)){echo "";}else{echo "$BarcodeMulti";} ?>">
            </div>
            <div class="form-group col-md-1">
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                $harga_3= $data['harga3'];
                                $harga_4= $data['harga4'];
                                $TampilkanBarcode= $data['barcode'];
                        ?>
                        <tr>
                            <td><?php echo "$no";?></td>
                            <td><?php echo "$TampilkanBarcode";?></td>
                            ...
                            <td>
                                <button title="Edit Data" class="btn btn-sm btn-outline-warning" data-toggle="modal" data-target="#ModalEditMultiHarga" data-id="<?php echo "$id_obat,$id_multi";?>">
                                    <i class="menu-icon mdi mdi-pencil" aria-hidden="true"></i>
                                </button>
                                <button title="Hapus Data" class="btn btn-sm btn-inverse-outline-danger" data-toggle="modal" data-target="#ModalDeleteMultiHarga" data-id="<?php echo "$id_obat,$id_multi";?>">
