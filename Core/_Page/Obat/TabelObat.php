...
<script>
    $(document).ready(function(){
        ...
        $('#NextPage').click(function() {
            ...
            var batas = mode[1];
            var keyword = mode[2];
            var Kategori =$('#Getkategori').val();
            var OrderBy =$('#GetOrderBy').val();
            var ShortBy =$('#GetShortBy').val();
            $.ajax({
...
<div class="card-body">
    <div class="row">
        <div class="col col-md-12" style="height: 350px; overflow-y: scroll;">
                ...
                <table class="table table-bordered table-hover table-md scroll-container">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>
                                <select name="Kategori" id="KategoriObat" class="bg-dark text-white border">
                                    <?php
                                        if(empty($Kategori)){
                            ...
                            <th>
                                <div class="dropdown" onmousemove="this.style.cursor='pointer'">
                                    <div class="" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Harga Beli <i class="menu-icon mdi mdi-filter" aria-hidden="true"></i>
                                    </div>
                                    <div class="dropdown-menu border-primary" aria-labelledby="dropdownMenuButton">
...
<div class="card-body">
    <div class="row">
        <div class="form-group col col-md-3">
            ...
            <input type="text" readonly class="form-control" id="GetBatas" value="<?php echo "$batas"; ?>">
        </div>
        <div class="form-group col col-md-3">
            <label for="">Kategori</label>
            <input type="text" readonly class="form-control" id="Getkategori" value="<?php echo "$Kategori"; ?>">
        </div>
        <div class="form-group col col-md-3">
            <label for="">Halaman</label>
            <input type="text" readonly class="form-control" id="GetPage" value="<?php echo "$page"; ?>">
        </div>
        <div class="form-group col col-md-3">
            <label for="">Posisi</label>
            <input type="text" readonly class="form-control" id="GetPosisi" value="<?php echo "$posisi"; ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col col-md-3">
            <label for="">keyword</label>
            <input type="text" readonly class="form-control" id="Getkeyword" value="<?php echo "$keyword"; ?>">
        </div>
        <div class="form-group col col-md-3">
            <label for="">Order By</label>
            <input type="text" readonly class="form-control" id="GetOrderBy" value="<?php echo "$OrderBy"; ?>">
        </div>
        <div class="form-group col col-md-3">
            <label for="">ShortBy</label>
            <input type="text" readonly class="form-control" id="GetShortBy" value="<?php echo "$ShortBy"; ?>">
        </div>
        <div class="form-group col col-md-3">
