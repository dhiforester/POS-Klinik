<?php
    ...
    if(!empty($_POST['keyword_cari_barang'])){
        $keyword_cari_barang=$_POST['keyword_cari_barang'];
    }else{
        $keyword_cari_barang="";
    }
?>
    ...
    ?>
        $('#baris<?php echo "$i";?>').click(function() {
            ...
            $.ajax({
                ...
                method  : "POST",
                data    : { id_obat: id_obat, periode: periode },
                success: function (data) {
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <div class="input-group">
                    <input type="text" id="FormPencarian" name="keyword_cari_barang" class="form-control border-warning" placeholder="Cari.." value="<?php echo $keyword_cari_barang;?>">
                ...
                <table class="table table-bordered table-hover table-sm scroll-container">
                    ...
                    <tbody>
                        <?php
                            ...
                            if(empty($keyword_cari_barang)){
                                $query = mysqli_query($conn, "SELECT*FROM obat LIMIT 20");
                            }else{
                                $query = mysqli_query($conn, "SELECT*FROM obat WHERE nama like '%$keyword_cari_barang%' OR kode like '%$keyword_cari_barang%' LIMIT 20");
                            }
