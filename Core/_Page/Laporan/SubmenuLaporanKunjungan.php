<script>
    ...
    $('#ProsesTampilkanLaporanKunjunganPasien').submit(function(){ 
        var Loading='<div class="row text-center"><div class="form-group col col-md-12"><img src="images/loading.gif"></div></div>';
        var ProsesTampilkanLaporanKunjunganPasien=$('#ProsesTampilkanLaporanKunjunganPasien').serialize();
        $('#KontenLaporan').html(Loading);
        $.ajax({
            type 	: 'POST',
            url 	: '_Page/Laporan/TabelLaporanKunjunganPasien.php',
            data 	:  ProsesTampilkanLaporanKunjunganPasien,
...
<form action="javascript:void(0);" id="ProsesTampilkanLaporanKunjunganPasien">
