<div class="modal-header bg-primary">
    <div class="row">
        <div class="col col-md-12">
            <h3 class="text-white">
                <i class="mdi mdi-tag-text-outline"></i> Detail Faktur Retur
            </h3>
        </div>
    </div>
</div>
<?php
    ...
    if(empty($_POST['kode'])){
        ...
        echo '          <h4 class="text-danger">Loading...</h4>';
...
<script>
    ...
    $('#HapusFakturRetur').click(function(){
        ...
        $.ajax({
            ...
            data 	: { kode: kode },
            success : function(data){
                $('#NotifikasiHapusRetur').html(data);
                $('#ModalDetailFakturRetur').modal('hide');
